export function CtaSection() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-32 bg-black text-white relative z-10">
      <div className="max-w-4xl text-center space-y-8">
        ...
        <div className="pt-8">
          <a
            href="dashboard.html"
            className="inline-block px-10 py-5 bg-white text-black font-semibold rounded-lg hover:bg-gray-100 transition text-lg"
          >
            Launch Live Demo
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p class="text-sm text-gray-600">AI-powered incident triage.</p>
          </div>
          <div>
