    ...
    >
      ...
      >
        <p className="text-lg md:text-xl text-[#5A635A] leading-relaxed font-normal mb-14 max-w-2xl">
          Whether you have production errors, stack traces, or webhook alerts,
          <br />
          paste them in and get instant root cause analysis powered by AI.
        </p>
      </motion.div>
