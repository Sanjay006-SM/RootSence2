...
export default function HeroSection() {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-28 pb-4 relative overflow-hidden">
      ...
      <svg
        viewBox="0 0 300 300"
        className="absolute top-4 left-4 lg:left-12 w-64 h-64 lg:w-80 lg:h-80 pointer-events-none hidden md:block z-0"
        aria-hidden="true"
      >
      ...
      {/* Top-Right Asymmetric Network Topology Corner Accent (Distinct node layout) */}
      <svg
        viewBox="0 0 300 300"
        className="absolute top-4 right-4 lg:right-12 w-56 h-56 lg:w-72 lg:h-72 pointer-events-none hidden md:block z-0"
        aria-hidden="true"
      >
